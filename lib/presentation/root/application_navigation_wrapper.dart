...
//     final introductionState = context.read<IntroductionBloc>().state;
//     final isAuthenticated = authState.status == AuthStateStatus.unAuthenticated || authState.status == AuthStateStatus.authenticatedAsGuest;

//     if (isAuthenticated && introductionState.status == IntroductionStateStatus.loaded && introductionState.isIntroSeen && !context.appSettings.skipLogin) {
